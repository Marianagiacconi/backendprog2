...
import edu.um.alumno.config.Constants;
import edu.um.alumno.domain.User;
import edu.um.alumno.repository.UserRepository;
import edu.um.alumno.security.AuthoritiesConstants;
import edu.um.alumno.service.MailService;
...
import edu.um.alumno.web.rest.errors.EmailAlreadyUsedException;
import edu.um.alumno.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link edu.um.alumno.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            LOG.warn("A new user cannot already have an ID");
            throw new BadRequestAlertException("A new user cannot already have an ID", "userManagement", "idexists");
            // Lowercase the user login before comparing with database
        } else if (userRepository.findOneByLogin(userDTO.getLogin().toLowerCase()).isPresent()) {
            LOG.warn("Login already in use");
