...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, edu.um.alumno.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, edu.um.alumno.repository.UserRepository.USERS_BY_EMAIL_CACHE);
